package Z_javaClassicBook.InputOutput;
...
//                    Files.newInputStream(originPath,StandardOpenOption.READ);
...
//    }
    ...
    public static void main(String[] args) {
        ...
        Path destination = Paths.get("C:\\temp\\line4.bmp");
        try {
...
//            }
            byte[] readData = new byte[1024];
            try(InputStream inputStream =
                        Files.newInputStream(origin,StandardOpenOption.READ);
                OutputStream outputStream =
